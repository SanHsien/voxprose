# mlx-gpu-thread-safety Specification

## Purpose

TBD - created by archiving change 'release-v2914-mlx-gpu-lock'. Update Purpose after archive.
...
<!-- @trace
source: release-v2914-mlx-gpu-lock
updated: 2026-05-14
code:
